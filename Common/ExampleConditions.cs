...
namespace CorpsMod.Common
{
	// This class contains conditions that will be reused in multiple places in CorpsMod.
	...
	{
		public static Condition InExampleBiome = new Condition("Mods.CorpsMod.Conditions.InExampleBiome", () => Main.LocalPlayer.InModBiome<ExampleSurfaceBiome>() || Main.LocalPlayer.InModBiome<ExampleUndergroundBiome>());
		public static Condition DownedMinionBoss = new("Mods.CorpsMod.Conditions.DownedMinionBoss", () => DownedBossSystem.downedMinionBoss);
	}
}
