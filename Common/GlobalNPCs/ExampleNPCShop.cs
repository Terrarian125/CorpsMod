...
using CorpsMod.Content.Items.Ammo;
using CorpsMod.Content.Items.Consumables;
using CorpsMod.Content.Items.Mounts;
	...
	class ExampleNPCShop : GlobalNPC
	{
		public override void ModifyShop(NPCShop shop) {
			if (shop.NpcType == NPCID.Dryad) {
				...
				shop.Add(new Item(ModContent.ItemType<ExampleMountItem>()) {
					shopCustomPrice = 2,
					shopSpecialCurrency = CorpsMod.ExampleCustomCurrencyId
				});
			}
			...
			var redPotCondition = new Condition("Mods.CorpsMod.Conditions.NotSellingExampleItem", () => !Condition.HappyWindyDay.IsMet() || !Condition.HappyEnough.IsMet());
