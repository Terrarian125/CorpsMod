...
namespace CorpsMod.Common.UI.ExampleResourceUI
{
	...
	internal class ExampleResourceBar : UIState
	{
		...
		public override void OnInitialize() {
			...
			barFrame = new UIImage(ModContent.Request<Texture2D>("CorpsMod/Common/UI/ExampleResourceUI/ExampleResourceFrame")); // Frame of our resource bar
