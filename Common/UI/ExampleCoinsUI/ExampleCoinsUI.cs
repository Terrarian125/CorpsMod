...
namespace CorpsMod.Common.UI.ExampleCoinsUI
{
	...
	internal class ExampleCoinsUIState : UIState
	{
		...
		public override void OnInitialize() {
			...
			ExampleUIHoverImageButton playButton = new ExampleUIHoverImageButton(buttonPlayTexture, Language.GetTextValue("Mods.CorpsMod.UI.ExampleCoinsUIState.Reset"));
