...
using CorpsMod.Common.GlobalItems;
using Terraria;
using Terraria.DataStructures;
using Terraria.ModLoader;

// Related to GlobalItem: WeaponWithGrowingDamage
namespace CorpsMod.Common.GlobalProjectiles
{
	public class ProjectileWithGrowingDamage : GlobalProjectile
	{
		...
		public override bool IsLoadingEnabled(Mod mod) {
			...
			return ModContent.GetInstance<CorpsModConfig>().WeaponWithGrowingDamageToggle;
		}
