...
namespace CorpsMod.Common.Systems
{
	...
	public class ExampleGameTipsSystem : ModSystem
	{
		...
		public override void ModifyGameTipVisibility(IReadOnlyList<GameTipData> gameTips) {
			...
			GameTipData disabledTip = gameTips.FirstOrDefault(tip => tip.FullName == "CorpsMod/DisabledExampleTip");
			...
			// GameTipData disabledTip = gameTips.FirstOrDefault(tip => tip.Mod is Mod { Name: "CorpsMod" } && tip.Name == "DisabledExampleTip");
