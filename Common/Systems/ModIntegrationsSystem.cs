...
namespace CorpsMod.Common.Systems
{
	...
	// In addition to the examples shown here, CorpsMod also integrates with the Census Mod (https://steamcommunity.com/sharedfiles/filedetails/?id=2687866031)
	...
	public class ModIntegrationsSystem : ModSystem
	{
		...
		private void DoBossChecklistIntegration() {
			...
			var customPortrait = (SpriteBatch sb, Rectangle rect, Color color) => {
				Texture2D texture = ModContent.Request<Texture2D>("CorpsMod/Assets/Textures/Bestiary/MinionBoss_Preview").Value;
