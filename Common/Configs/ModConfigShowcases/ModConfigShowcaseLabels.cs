using CorpsMod.Common.Configs.CustomDataTypes;
...
namespace CorpsMod.Common.Configs.ModConfigShowcases
{
	...
	public class ModConfigShowcaseLabels : ModConfig
	{
		...
		// By default, all ModConfig fields and properties will have an automatically assigned Label and Tooltip translation key. You'll find these translation keys in your translation files. All of the English translations for the configs in CorpsMod are found in CorpsMod/Localization/en-US_Mods.CorpsMod.Configs.hjson
		...
		[LabelKey("$Mods.CorpsMod.Configs.Common.LocalizedLabel")]
		[TooltipKey("$Mods.CorpsMod.Configs.Common.LocalizedTooltip")]
		...
		// Note: using nameof can help avoid typos and errors. That would look like: $"$Mods.CorpsMod.Items.{nameof(ExampleYoyo)}.DisplayName"
		// Note: These examples use color and item chat tags. See here for help on using Tags: https://terraria.wiki.gg/wiki/Chat#Tags
		const string InterpolatedLabel = "$Mods.CorpsMod.Configs.Common.InterpolatedLabel";
		const string InterpolatedTooltip = "$Mods.CorpsMod.Configs.Common.InterpolatedTooltip";

		[LabelKey(InterpolatedLabel), TooltipKey(InterpolatedTooltip)] // Attributes can also be combined into a single line
		[LabelArgs("CorpsMod/ExampleYoyo", 1, "=>", "$Mods.CorpsMod.Items.ExampleYoyo.DisplayName")]
		[TooltipArgs("$Mods.CorpsMod.Items.ExampleYoyo.DisplayName", "FF55AA", "22a2dd")]
		public bool InterpolatedTextA;

		[LabelKey(InterpolatedLabel), TooltipKey(InterpolatedTooltip)]
		[LabelArgs("CorpsMod/ExampleSword", 2, "=>", "$Items.ExampleSword.DisplayName")] // due to scope simplification, "Mods.CorpsMod." can be omitted. (https://github.com/tModLoader/tModLoader/wiki/Localization#scope-simplification)
		[TooltipArgs("$Mods.CorpsMod.Items.ExampleSword.DisplayName", "77bd8e", "88AADD")]
		...
		// Using [Header("HeaderIdentifier")], Mods.CorpsMod.Configs.ModConfigShowcaseLabels.Headers.HeaderIdentifier will automatically appear in localization files. We have populated the English entry with the value "Headers Section".
		...
		[Header("$Mods.CorpsMod.Configs.Common.LocalizedHeader")]
