...
using CorpsMod.Content.Prefixes;
...
namespace CorpsMod.Common.Configs.ModConfigShowcases
{
	...
	public class ModConfigShowcaseDataTypes : ModConfig
	{
		...
		public ProjectileDefinition projectileDefinitionExample = new ProjectileDefinition("CorpsMod", nameof(Content.Projectiles.ExampleHomingProjectile));
		public BuffDefinition buffDefinitionExample = new BuffDefinition("CorpsMod", nameof(Content.Buffs.ExampleDefenseBuff));
		public TileDefinition tileDefinitionExample = new TileDefinition("CorpsMod", nameof(Content.Tiles.ExampleBlock));
		...
		public Dictionary<PrefixDefinition, float> prefixDefinitionDictionaryExample = new Dictionary<PrefixDefinition, float>() {
			[new PrefixDefinition(nameof(CorpsMod), nameof(ExamplePrefix))] = 0.5f,
