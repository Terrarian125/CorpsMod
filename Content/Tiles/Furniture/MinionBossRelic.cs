...
namespace CorpsMod.Content.Tiles.Furniture
{
	...
	public class MinionBossRelic : ModTile
	{
		...
		public virtual string RelicTextureName => "CorpsMod/Content/Tiles/Furniture/MinionBossRelic";

		// All relics use the same pedestal texture, this one is copied from vanilla
		public override string Texture => "CorpsMod/Content/Tiles/Furniture/RelicPedestal";
	...
	{
		public override string RelicTextureName => "CorpsMod/Content/Tiles/Furniture/MyBossRelic";
