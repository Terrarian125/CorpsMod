...
namespace CorpsMod.Content.Tiles
{
	public class ExampleCactus : ModCactus
	{
		...
		public override void SetStaticDefaults() {
			...
			texture = ModContent.Request<Texture2D>("CorpsMod/Content/Tiles/Plants/ExampleCactus");
			fruitTexture = ModContent.Request<Texture2D>("CorpsMod/Content/Tiles/Plants/ExampleCactus_Fruit");
		}
