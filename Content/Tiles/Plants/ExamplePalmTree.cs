...
namespace CorpsMod.Content.Tiles
{
	public class ExamplePalmTree : ModPalmTree
	{
		...
		public override void SetStaticDefaults() {
			...
			texture = ModContent.Request<Texture2D>("CorpsMod/Content/Tiles/Plants/ExamplePalmTree");
			oasisTopsTexture = ModContent.Request<Texture2D>("CorpsMod/Content/Tiles/Plants/ExamplePalmOasisTree_Tops");
			topsTexture = ModContent.Request<Texture2D>("CorpsMod/Content/Tiles/Plants/ExamplePalmTree_Tops");
		}
