...
namespace CorpsMod.Content.Tiles
{
	public class ExampleTree : ModTree
	{
		...
		public override void SetStaticDefaults() {
			...
			texture = ModContent.Request<Texture2D>("CorpsMod/Content/Tiles/Plants/ExampleTree");
			branchesTexture = ModContent.Request<Texture2D>("CorpsMod/Content/Tiles/Plants/ExampleTree_Branches");
			topsTexture = ModContent.Request<Texture2D>("CorpsMod/Content/Tiles/Plants/ExampleTree_Tops");
		}
