...
namespace CorpsMod.Content.Tiles
{
	...
	{
		public override string Texture => $"CorpsMod/Content/Tiles/TileObjectDataShowcaseItemA";
	...
	{
		public override string Texture => $"CorpsMod/Content/Tiles/TileObjectDataShowcaseItemB";
