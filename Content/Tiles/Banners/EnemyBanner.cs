...
namespace CorpsMod.Content.Tiles.Banners
{
	// This tile is for enemy banners (https://terraria.wiki.gg/wiki/Banners_(enemy)). Several ModNPC in CorpsMod (ExampleZombieThief and PartyZombie) share a banner with an existing enemy, but the enemies represented in this tile have their own.
	...
	// Note that if you use this approach, move this class to the CorpsMod.Content.Items.Placeable.Banners namespace if you want to keep loading banner item textures from that folder.
