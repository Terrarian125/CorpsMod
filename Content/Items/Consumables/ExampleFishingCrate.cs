...
namespace CorpsMod.Content.Items.Consumables
{
	...
	public class ExampleFishingCrate : ModItem
	{
		...
		public override void ModifyItemLoot(ItemLoot itemLoot) {
			...
			// Drop pre-hm ores, with the addition of one from CorpsMod
			...
			// Drop pre-hm bars (except copper/tin), with the addition of one from CorpsMod
			...
			// Drop an "exploration utility" potion, with the addition of one from CorpsMod
