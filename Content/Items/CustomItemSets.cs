...
namespace CorpsMod.Content.Items
{
	...
	public static class CustomItemSets
	{
		...
		// The key we provide using this method overload will automatically have "ModName/" added to the start, meaning that the real key for this example is "CorpsMod/FlamingWeapon".
	...
	public class CustomItemSetsSystem : ModSystem
	{
		public override void Load() {
			...
			// ItemID.Sets.Factory.MergeNamedSets<bool>("OtherMod/FireWeapons", "CorpsMod/FlamingWeapon");
		}
