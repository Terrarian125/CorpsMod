...
namespace CorpsMod.Content.Items.Placeable
{
	...
	public class ExampleTrap : ModItem
	{
		...
		public static string GetInternalNameFromStyle(int style) {
			...
			// We use these in the CorpsMod.Content.Tiles.ExampleTrap.GetItemDrops rather than ModContent.ItemType<Items.Placeable.ExampleTrap>() to retrieve the correct ItemID.
			if (style == 0) {
