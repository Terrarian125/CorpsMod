using CorpsMod.Common.GlobalProjectiles;
...
{
	public class CorpsModifiedProjectilesItem : ModItem
	{
		public override string Texture => "CorpsMod/Content/Items/Weapons/ExampleShootingSword";
