...
namespace CorpsMod.Content.Items
{
	...
	{
		public override string Texture => "CorpsMod/Content/Items/ExampleItem";
		...
		public override void ModifyTooltips(List<TooltipLine> tooltips) {
			TooltipLine tooltip = new TooltipLine(Mod, "CorpsMod: HotPotato", CountdownText.Format(Math.Round(timer / 60f, 1))) { OverrideColor = Color.Red };
