...
namespace CorpsMod.Content.Prefixes
{
	...
	public class ExamplePrefix : ModPrefix
	{
		...
		public override IEnumerable<TooltipLine> GetTooltipLines(Item item) {
			...
			// The localization key for Mods.CorpsMod.Prefixes.PowerTooltip uses a special format that will automatically prefix + or - to the value.
