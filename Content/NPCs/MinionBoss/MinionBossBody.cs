...
using CorpsMod.Content.BossBars;
using CorpsMod.Content.Items;
using CorpsMod.Content.Items.Armor.Vanity;
using CorpsMod.Content.Items.Consumables;
using CorpsMod.Content.Pets.MinionBossPet;
...
namespace CorpsMod.Content.NPCs.MinionBoss
{
	...
	public class MinionBossBody : ModNPC
	{
		...
		public override void SetStaticDefaults() {
			...
			NPCID.Sets.NPCBestiaryDrawModifiers drawModifiers = new NPCID.Sets.NPCBestiaryDrawModifiers() {
				CustomTexturePath = "CorpsMod/Assets/Textures/Bestiary/MinionBoss_Preview",
		...
		public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry) {
			...
			bestiaryEntry.Info.AddRange(new List<IBestiaryInfoElement> {
				...
				new FlavorTextBestiaryInfoElement("Mods.CorpsMod.Bestiary.MinionBossBody")
			});
		}
