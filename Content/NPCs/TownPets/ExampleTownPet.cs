...
namespace CorpsMod.Content.NPCs.TownPets
{
	[AutoloadHead]
	public class ExampleTownPet : ModNPC
	{
		...
		public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry) {
			...
			[
				...
				new FlavorTextBestiaryInfoElement("Mods.CorpsMod.Bestiary.ExampleTownPet")
			]);
		}
		...
		public override List<string> SetNPCNameList() {
			return NPC.townNpcVariationIndex switch { // Change the name based on the variation.
				...
				// One additional benefit of this approach is a separate mod can add a Mods.CorpsMod.NPCs.ExampleTownPet.Names.Green.Emerald key and it will automatically be used as an name option.
		...
		public override string GetChat() {
			...
			chat.Add(Language.GetTextValue("Mods.CorpsMod.Dialogue.ExampleTownPet.StandardDialogue"));
		...
		public override void EmoteBubblePosition(ref Vector2 position, ref SpriteEffects spriteEffects) {
			...
			// (For a working example, see CorpsMod/Common/GlobalNPCs/GuideGlobalNPC.cs)
		}
		*/
	...
	{
		private static readonly string filePath = "CorpsMod/Content/NPCs/TownPets/ExampleTownPet"; // The path to our base texture.
