...
namespace CorpsMod
{
	...
	public partial class CorpsMod : Mod
	{
		...
		public override void Load() {
			...
			ExampleCustomCurrencyId = CustomCurrencyManager.RegisterCurrency(new Content.Currencies.ExampleCustomCurrency(ModContent.ItemType<Content.Items.ExampleItem>(), 999L, "Mods.CorpsMod.Currencies.ExampleCustomCurrency"));
		}
